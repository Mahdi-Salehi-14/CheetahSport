                ...
                <div>
                    <form action="" method="post" class="col-md-3">
                        ...
                        <div class="btn-group mb-4">
                            <input type="radio" class="btn-check" name="category" id="sportshoes" autocomplete="off" checked />
                            <label class="btn btn-secondary" for="sportshoes">کفش ورزشی</label>

                            <input type="radio" class="btn-check" name="category" id="sportsequipment" autocomplete="off" />
                            <label class="btn btn-secondary" for="sportsequipment">وسیله ورزشی</label>

                            <input type="radio" class="btn-check" name="category" id="womensportswear" autocomplete="off" />
                            <label class="btn btn-secondary" for="womensportswear">لباس ورزشی زنانه</label>

                            <input type="radio" class="btn-check" name="category" id="mensportswear" autocomplete="off" />
                            <label class="btn btn-secondary" for="mensportswear">لباس ورزشی مردانه</label>
                        </div>
                        <div class="btn-group mb-4">
                            <input type="radio" class="btn-check" name="brand" id="adidas" autocomplete="off" checked />
                            <label class="btn btn-secondary" for="adidas">Adidas</label>

                            <input type="radio" class="btn-check" name="brand" id="nike" autocomplete="off" />
                            <label class="btn btn-secondary" for="nike">Nike</label>

                            <input type="radio" class="btn-check" name="brand" id="reebok" autocomplete="off" />
                            <label class="btn btn-secondary" for="reebok">Reebok</label>

                            <input type="radio" class="btn-check" name="brand" id="underarmour" autocomplete="off" />
